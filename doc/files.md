...
* pesium.conf: contains configuration settings for pesiumd or pesium-qt
* pesiumd.pid: stores the process id of pesiumd while running
...
* debug.log: contains debug information and general logging generated by pesiumd or pesium-qt
