...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18267
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 18268
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 28267
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 28268
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 18267
	%{_sbindir}/semanage port -d -p tcp 18268
	%{_sbindir}/semanage port -d -p tcp 28267
	%{_sbindir}/semanage port -d -p tcp 28268
