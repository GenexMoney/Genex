...
"""Verify that starting pesium with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pesium with -h for help text")
        ...
        self.log.info("Start pesium with -version for version information")
