...
const char * const BITCOIN_CONF_FILENAME = "pesium.conf";
const char * const BITCOIN_PID_FILENAME = "pesiumd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Pesium";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pesium";
#else
    // Unix
    return pathRet / ".pesium";
#endif
#endif
}
