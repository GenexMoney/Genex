...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pesium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pesium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pesium transaction") + "\n" +
              "  pesium-tx [options] -create [commands]   " + _("Create hex-encoded pesium transaction") + "\n" +
              "\n";
